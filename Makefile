...
DUCKDB_COMMON_BUILD_FLAGS := BUILD_SHELL=0 BUILD_UNITTESTS=0 BUILD_AUTOCOMPLETE=0 BUILD_TPCH=0 BUILD_TPCDS=0 BUILD_TPCE=0 BUILD_FTS=0 BUILD_HTTPFS=0 BUILD_JSON=0 BUILD_INET=0 BUILD_SQLSMITH=0 DUCKDB_PLATFORM=any
